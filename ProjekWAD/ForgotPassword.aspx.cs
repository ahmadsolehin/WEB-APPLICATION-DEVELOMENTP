    ...
    protected void btPassRec_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection con = new SqlConnection(CS))
        {
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                String EmailBody = "Hi " + Username + ",<br/><br/> Click the link below to reset your password <br/><br/> http://localhost:2781/ProjekWAD/RecoverPassword.aspx?Uid=" + myGUID;
                MailMessage PassRecMail = new MailMessage("solehinjr@gmail.com", ToEmailAddress);
                ...
                {
                    UserName = "solehinjr@gmail.com",
                    Password = "931128065299_as"
                };
                SMTP.EnableSsl = true;
